...
*
******************************************************************************/
void CalculatePhases(XV_Hscaler_l2 *HscPtr,
                            u32 WidthIn,
                            u32 WidthOut,
                            u32 PixelRate)
{
...
*        scaler can be used
******************************************************************************/
void XV_HScalerSetPhase(XV_Hscaler_l2 *HscPtr)
{
  u32 loopWidth;
  UINTPTR baseAddr;
  //program phases
                     ...
                     u32 ColorFormatOut)
{
 ...
 printf("%s: PixelRate : %x \n", __func__, PixelRate);
  if(InstancePtr->Hsc.Config.ScalerType == XV_HSCALER_POLYPHASE)
  {
	...
	printf("%s: Determining coefficient table to use \n",__func__);
